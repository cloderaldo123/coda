...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<ScrollrouteService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
void registerServices() {
  ...
  getAndRegisterScrollrouteService();
...
MockScrollrouteService getAndRegisterScrollrouteService() {
  _removeRegistrationIfExists<ScrollrouteService>();
  final service = MockScrollrouteService();
  locator.registerSingleton<ScrollrouteService>(service);
  return service;
}
// @stacked-mock-create
